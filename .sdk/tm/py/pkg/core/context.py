...
from projectname_sdk.core.control import FussyApiDocumentationControl
...
class FussyApiDocumentationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FussyApiDocumentationControl()
        ...
        if isinstance(sp, FussyApiDocumentationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FussyApiDocumentationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FussyApiDocumentationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return FussyApiDocumentationOperation({})
        ...
        op = FussyApiDocumentationOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return FussyApiDocumentationError(code, msg, self)
