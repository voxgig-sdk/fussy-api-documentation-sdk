# FussyApiDocumentation SDK feature corpus test
#
...
def _client(kase):
    ...
    FussyApiDocumentationSDK(...), not FussyApiDocumentationSDK.test(...): the `test` feature is
    ...
    return FussyApiDocumentationSDK(opts)
