...
// FussyApiDocumentation SDK timeout feature
...
class FussyApiDocumentationTimeoutFeature extends FussyApiDocumentationBaseFeature
{
    ...
    private function _with_timeout(FussyApiDocumentationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FussyApiDocumentationContext $_ctx, float $ms): void
    {
        $client = $this->client;
