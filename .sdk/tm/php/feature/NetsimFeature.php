...
// FussyApiDocumentation SDK netsim feature
...
class FussyApiDocumentationNetsimFeature extends FussyApiDocumentationBaseFeature
{
    ...
    private function _simulate(FussyApiDocumentationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FussyApiDocumentationContext $ctx, array $applied): void
    {
        $client = $this->client;
