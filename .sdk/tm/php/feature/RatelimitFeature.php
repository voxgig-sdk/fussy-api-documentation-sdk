...
// FussyApiDocumentation SDK ratelimit feature
...
class FussyApiDocumentationRatelimitFeature extends FussyApiDocumentationBaseFeature
{
    ...
    private function _acquire(FussyApiDocumentationContext $ctx): void
    {
    ...
    private function _track(FussyApiDocumentationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
