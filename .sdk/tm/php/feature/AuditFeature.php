...
// FussyApiDocumentation SDK audit feature
...
class FussyApiDocumentationAuditFeature extends FussyApiDocumentationBaseFeature
{
    ...
    private function _emit(FussyApiDocumentationContext $ctx, string $outcome): void
    {
