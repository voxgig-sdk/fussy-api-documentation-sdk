...
// FussyApiDocumentation SDK utility: graphql
//
...
class FussyApiDocumentationGraphql
{
    ...
    // equivalent.
    public static function body(FussyApiDocumentationContext $ctx): mixed
    {
    ...
    public static function errors(FussyApiDocumentationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
