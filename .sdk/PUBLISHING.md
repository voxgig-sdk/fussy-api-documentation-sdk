...
|---|---|---|
| `ts/` | @voxgig-sdk/fussy-api-documentation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fussy-api-documentation-sdk \
      --repository voxgig-sdk/fussy-api-documentation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fussy-api-documentation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fussy-api-documentation-sdk --id=<id>` removes it.
