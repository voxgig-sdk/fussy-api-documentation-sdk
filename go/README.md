# FussyApiDocumentation Golang SDK



The Golang SDK for the FussyApiDocumentation API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/fussy-api-documentation-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/fussy-api-documentation-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/fussy-api-documentation-sdk/go=../fussy-api-documentation-sdk/go
```
...
### NewFussyApiDocumentationSDK

```go
func NewFussyApiDocumentationSDK(options map[string]any) *FussyApiDocumentationSDK
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FussyApiDocumentationSDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### FussyApiDocumentationSDK methods
...
| `GraphQl` | `(data map[string]any) FussyApiDocumentationEntity` | Create a GraphQl entity instance. |

### Entity interface (FussyApiDocumentationEntity)

All entities implement the `FussyApiDocumentationEntity` interface.
...
```
github.com/voxgig-sdk/fussy-api-documentation-sdk/go/
├── fussy-api-documentation.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/fussy-api-documentation-sdk/go`) re-exports everything needed
...
graphql.List(nil, nil)

// graphql.Data() now returns the graphql data from the last list
// graphql.Match() returns the last match criteria
```
