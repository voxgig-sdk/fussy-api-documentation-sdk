...
type GraphQlEntity struct {
	name    string
	client  *core.FussyApiDocumentationSDK
...
func NewGraphQlEntity(client *core.FussyApiDocumentationSDK, entopts map[string]any) *GraphQlEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GraphQlEntity) GetName() string { return e.name }
...
func (e *GraphQlEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GraphQlEntity) Deleted() bool {
	return e.deleted
}


func (e *GraphQlEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGraphQlEntity(e.client, opts)
}

func (e *GraphQlEntity) Data(args ...any) any {
...
func (e *GraphQlEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GraphQlEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GraphQlEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *GraphQlEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *GraphQlEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GraphQlEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GraphQlEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
