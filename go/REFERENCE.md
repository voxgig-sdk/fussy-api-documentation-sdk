# FussyApiDocumentation Golang SDK Reference

Complete API reference for the FussyApiDocumentation Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *FussyApiDocumentationSDK`
...
#### `GraphQl(data map[string]any) FussyApiDocumentationEntity`
