# FussyApiDocumentation Python SDK Reference

Complete API reference for the FussyApiDocumentation Python SDK.
...
#### `FussyApiDocumentationSDK.test(testopts=None, sdkopts=None)`
...
```python
results = client.GraphQl().list({"query": "example"})
