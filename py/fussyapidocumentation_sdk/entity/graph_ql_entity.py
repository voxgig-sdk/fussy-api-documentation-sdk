...
from fussyapidocumentation_sdk.fussyapidocumentation_types import (
    GraphQl,
    GraphQlListMatch,
    GraphQlCreateData,
)
...
class GraphQlEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GraphQlEntity(self._client, opts)
    ...
    def create(self, reqdata: GraphQlCreateData, ctrl=None) -> GraphQl:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
