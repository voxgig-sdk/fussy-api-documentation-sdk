# FussyApiDocumentation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FussyApiDocumentationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FussyApiDocumentationSDK(...) and FussyApiDocumentationSDK.test(...) become
#      FussyApiDocumentationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fussyapidocumentation_sdk"
_SDK_CLASS = "FussyApiDocumentationSDK"
