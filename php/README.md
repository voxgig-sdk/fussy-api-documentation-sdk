# FussyApiDocumentation PHP SDK

The PHP SDK for the FussyApiDocumentation API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GraphQl(null)->list(null, null);
...
```php
// Create
[$created, $_] = $client->GraphQl(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->FussyApiDocumentation(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── fussyapidocumentation_sdk.php          -- Main SDK class
...
The main class (`fussyapidocumentation_sdk.php`) exports the SDK class
