...
// FussyApiDocumentation SDK debug feature
...
class FussyApiDocumentationDebugFeature extends FussyApiDocumentationBaseFeature
{
    ...
    private function _finish(FussyApiDocumentationContext $ctx, bool $ok): void
    {
