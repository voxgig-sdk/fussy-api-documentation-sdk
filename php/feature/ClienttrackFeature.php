...
// FussyApiDocumentation SDK clienttrack feature
...
class FussyApiDocumentationClienttrackFeature extends FussyApiDocumentationBaseFeature
{
    ...
    public function PostConstruct(FussyApiDocumentationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FussyApiDocumentation-SDK';
