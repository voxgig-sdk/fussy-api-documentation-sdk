...
// FussyApiDocumentation SDK cache feature
...
class FussyApiDocumentationCacheFeature extends FussyApiDocumentationBaseFeature
{
    ...
    private function _through(FussyApiDocumentationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
