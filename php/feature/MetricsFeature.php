...
// FussyApiDocumentation SDK metrics feature
...
class FussyApiDocumentationMetricsFeature extends FussyApiDocumentationBaseFeature
{
    ...
    private function _record(FussyApiDocumentationContext $ctx, bool $ok): void
    {
