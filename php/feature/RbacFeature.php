...
// FussyApiDocumentation SDK rbac feature
...
class FussyApiDocumentationRbacFeature extends FussyApiDocumentationBaseFeature
{
    ...
    private function _required(FussyApiDocumentationContext $ctx): ?string
    {
    ...
    private function _reject(FussyApiDocumentationContext $ctx, string $required): void
    {
    ...
    private function _track(FussyApiDocumentationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
