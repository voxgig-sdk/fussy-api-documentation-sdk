...
// FussyApiDocumentation SDK telemetry feature
...
class FussyApiDocumentationTelemetryFeature extends FussyApiDocumentationBaseFeature
{
    ...
    private function _close(FussyApiDocumentationContext $ctx, bool $ok): void
    {
