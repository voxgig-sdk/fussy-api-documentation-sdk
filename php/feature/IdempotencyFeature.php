...
// FussyApiDocumentation SDK idempotency feature
...
class FussyApiDocumentationIdempotencyFeature extends FussyApiDocumentationBaseFeature
{
    ...
    private function _mutating(FussyApiDocumentationContext $ctx): bool
    {
