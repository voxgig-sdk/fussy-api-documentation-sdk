...
// FussyApiDocumentation SDK streaming feature
...
class FussyApiDocumentationStreamingFeature extends FussyApiDocumentationBaseFeature
{
    ...
    private function _iterate(FussyApiDocumentationResult $result): \Generator
    {
    ...
    private function _streamable(FussyApiDocumentationContext $ctx): bool
    {
