...
// FussyApiDocumentation SDK proxy feature
...
class FussyApiDocumentationProxyFeature extends FussyApiDocumentationBaseFeature
{
    ...
    public function init(FussyApiDocumentationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FussyApiDocumentationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
