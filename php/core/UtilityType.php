...
// FussyApiDocumentation SDK utility type

class FussyApiDocumentationUtility
{
    ...
    public static function copy(FussyApiDocumentationUtility $src): FussyApiDocumentationUtility
    {
        $u = new FussyApiDocumentationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
