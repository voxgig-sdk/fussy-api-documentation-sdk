...
// FussyApiDocumentation SDK pipeline test
//
...
{
    private static function utility(): FussyApiDocumentationUtility
    {
        return new FussyApiDocumentationUtility();
    }
    ...
    private static function ctx(array $over = []): FussyApiDocumentationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FussyApiDocumentationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FussyApiDocumentationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FussyApiDocumentationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FussyApiDocumentationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FussyApiDocumentationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FussyApiDocumentationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FussyApiDocumentationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FussyApiDocumentationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FussyApiDocumentationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FussyApiDocumentationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FussyApiDocumentationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FussyApiDocumentationResponse([]),
            'result' => new FussyApiDocumentationResult([]),
        ]);
        [, $err] = FussyApiDocumentationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FussyApiDocumentationSpec([]),
            'response' => null,
            'result' => new FussyApiDocumentationResult([]),
        ]);
        [, $err] = FussyApiDocumentationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FussyApiDocumentationSpec(['step' => 's']),
            'response' => new FussyApiDocumentationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FussyApiDocumentationResult([]),
        ]);
        [, $err] = FussyApiDocumentationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FussyApiDocumentationSpec(['step' => 's']),
            'response' => new FussyApiDocumentationResponse(self::resp(200, ['v' => 1])),
            'result' => new FussyApiDocumentationResult([]),
        ]);
        [, $err] = FussyApiDocumentationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FussyApiDocumentationSpec(['step' => 's']),
            'response' => new FussyApiDocumentationResponse(self::resp(200, ['v' => 2])),
            'result' => new FussyApiDocumentationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FussyApiDocumentationMakeResponse::call($ctx);
    ...
    {
        $preset = new FussyApiDocumentationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FussyApiDocumentationSpec([]),
            'response' => new FussyApiDocumentationResponse([]),
            'result' => new FussyApiDocumentationResult([]),
        ...
        [$got, $err] = FussyApiDocumentationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FussyApiDocumentationResult([])]);
        [, $err] = FussyApiDocumentationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FussyApiDocumentationSpec([]), 'result' => null]);
        [, $err] = FussyApiDocumentationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FussyApiDocumentationSpec(['step' => 's']),
            'result' => new FussyApiDocumentationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FussyApiDocumentationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FussyApiDocumentationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FussyApiDocumentationSpec(['step' => 's']),
            'result' => new FussyApiDocumentationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FussyApiDocumentationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FussyApiDocumentationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FussyApiDocumentationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FussyApiDocumentationSpec([]),
            'result' => new FussyApiDocumentationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FussyApiDocumentationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FussyApiDocumentationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FussyApiDocumentationError('boom', 'boom');
        $utility->fetcher = function (FussyApiDocumentationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FussyApiDocumentationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FussyApiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FussyApiDocumentationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FussyApiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FussyApiDocumentationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FussyApiDocumentationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FussyApiDocumentationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FussyApiDocumentationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FussyApiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FussyApiDocumentationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FussyApiDocumentationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FussyApiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FussyApiDocumentationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FussyApiDocumentationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FussyApiDocumentationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FussyApiDocumentationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FussyApiDocumentationResult(['ok' => false])]);
        $this->expectException(FussyApiDocumentationError::class);
        FussyApiDocumentationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FussyApiDocumentationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FussyApiDocumentationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FussyApiDocumentationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FussyApiDocumentationBaseFeature();
        $b = new FussyApiDocumentationBaseFeature();
        FussyApiDocumentationFeatureAdd::call($ctx, $a);
        FussyApiDocumentationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FussyApiDocumentationBaseFeature
    {
        $f = new FussyApiDocumentationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FussyApiDocumentationFeatureAdd::call($ctx, self::named_feature('a'));
        FussyApiDocumentationFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        FussyApiDocumentationFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        FussyApiDocumentationFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        FussyApiDocumentationFeatureAdd::call($ctx, $replace);
        ...
        FussyApiDocumentationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FussyApiDocumentationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FussyApiDocumentationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FussyApiDocumentationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        FussyApiDocumentationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FussyApiDocumentationResponse(['headers' => null]),
            'result' => new FussyApiDocumentationResult([]),
        ]);
        FussyApiDocumentationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FussyApiDocumentationResultBody::call($ctx);
