...
class FussyApiDocumentationTestRunner
{
    ...
    {
        $live = self::getenv('FUSSYAPIDOCUMENTATION_TEST_LIVE');
        $override = self::getenv('FUSSYAPIDOCUMENTATION_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FUSSYAPIDOCUMENTATION_TEST_EXPLAIN');
