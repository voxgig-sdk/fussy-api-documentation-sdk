...
// FussyApiDocumentation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FussyApiDocumentationSDK::test)
...
{
    private const SDK_CLASS = 'FussyApiDocumentationSDK';
    ...
    private const SDK_BASE = 'fussyapidocumentation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../fussyapidocumentation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
