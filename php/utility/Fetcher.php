...
// FussyApiDocumentation SDK utility: fetcher

class FussyApiDocumentationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FussyApiDocumentationSDK/1.0)';
    ...
    public static function call(FussyApiDocumentationContext $ctx, string $fullurl, array $fetchdef): array
    {
