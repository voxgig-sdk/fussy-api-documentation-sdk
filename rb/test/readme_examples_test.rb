...
#      offline in seeded test mode (FussyApiDocumentationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FussyApiDocumentation_sdk.rb")
  SDK_CLASS = "FussyApiDocumentationSDK"
  ...
  SDK_BASE = "FussyApiDocumentation_sdk"
