# FussyApiDocumentation Ruby SDK Reference

Complete API reference for the FussyApiDocumentation Ruby SDK.
...
#### `FussyApiDocumentationSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.GraphQl.list(nil)
```
