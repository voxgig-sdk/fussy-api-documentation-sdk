# FussyApiDocumentation Ruby SDK



The Ruby SDK for the FussyApiDocumentation API — an entity-oriented client using idiomatic Ruby conventions.
...
```
rb/
├── FussyApiDocumentation_sdk.rb       -- Main SDK module
