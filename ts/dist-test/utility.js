...
function envOverride(m) {
    if ('TRUE' === process.env.FUSSY_API_DOCUMENTATION_TEST_LIVE ||
        'TRUE' === process.env.FUSSY_API_DOCUMENTATION_TEST_OVERRIDE) {
    ...
    m.FUSSY_API_DOCUMENTATION_TEST_EXPLAIN = process.env.FUSSY_API_DOCUMENTATION_TEST_EXPLAIN || m.FUSSY_API_DOCUMENTATION_TEST_EXPLAIN;
    return m;
}
