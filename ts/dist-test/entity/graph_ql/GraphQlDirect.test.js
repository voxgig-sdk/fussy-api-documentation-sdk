...
(0, node_test_1.describe)('GraphQlDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FussyApiDocumentationSDK({
    ...
    (0, node_test_1.test)('direct-list-graph_ql', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-graph_ql', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.FUSSY_API_DOCUMENTATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FussyApiDocumentationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.FUSSY_API_DOCUMENTATION_APIKEY,
        }));
        let idmap = env['FUSSY_API_DOCUMENTATION_TEST_GRAPH_QL_ENTID'];
    ...
    const client = new __1.FussyApiDocumentationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GraphQlDirect.test.js.map