...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.FUSSYAPIDOCUMENTATION_TEST_LIVE ||
    'TRUE' === process.env.FUSSYAPIDOCUMENTATION_TEST_OVERRIDE
  ) {
  ...
  m.FUSSYAPIDOCUMENTATION_TEST_EXPLAIN = process.env.FUSSYAPIDOCUMENTATION_TEST_EXPLAIN || m.FUSSYAPIDOCUMENTATION_TEST_EXPLAIN
