...
type Args struct {
	Entity string         `json:"entity" jsonschema:"graph_ql"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FussyApiDocumentationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "fussy-api-documentation_list",
		Description: "List records from FussyApiDocumentation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "fussy-api-documentation_load",
		Description: "Load a single record from FussyApiDocumentation. " +
...
func runOp(client *sdk.FussyApiDocumentationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FussyApiDocumentationSDK, name string) (sdk.FussyApiDocumentationEntity, error) {
	switch strings.ToLower(name) {
	case "graph_ql":
		return client.GraphQl(nil), nil
