// Command FussyApiDocumentation-mcp is an MCP server exposing the FussyApiDocumentation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FussyApiDocumentation_list  — list records of an entity
//	FussyApiDocumentation_load  — load a single record of an entity
//
