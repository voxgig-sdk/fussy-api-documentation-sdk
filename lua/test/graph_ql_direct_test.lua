...
describe("GraphQlDirect", function()
  it("should direct-list-graph_ql", function()
    local setup = graph_ql_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-graph_ql", setup.live and "live" or "unit")
