...
func registerSDKWords(r *eng.Registry, client *sdk.FussyApiDocumentationSDK) {
...
func runOp(client *sdk.FussyApiDocumentationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
